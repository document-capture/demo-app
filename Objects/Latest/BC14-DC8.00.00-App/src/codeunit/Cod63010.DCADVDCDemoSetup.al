codeunit 63010 "DCADV DC Demo Setup"
{
    ...
    procedure DownloadDemoDocuments(): Boolean
    var
        DemoSetup: Record "DCADV DC Demo Setup";
        Http: Codeunit "CSC Http";
        XmlDoc: Codeunit "CSC XML Document";
    ...
    var
        ...
        purchDocTypes: Option Quote,"Blanket Order",Order,Invoice,"Return Order","Credit Memo","Posted Receipt","Posted Invoice","Posted Return Shipment","Posted Credit Memo","Arch. Quote","Arch. Order","Arch. Blanket Order","Arch. Return Order";
